...
class TestLogin:
    ...
    def test_login_account_button_on_main_page_login_done(self):
    ...
    def test_login_personal_account_button_on_main_page_login_done(self):
        driver = webdriver.Chrome()
        driver.get('https://stellarburgers.nomoreparties.site/')
    ...
    def test_login_on_registration_page_login_done(self):
        driver = webdriver.Chrome()
    ...
    def test_login_on_recover_password_page_login_done(self):
        driver = webdriver.Chrome()
